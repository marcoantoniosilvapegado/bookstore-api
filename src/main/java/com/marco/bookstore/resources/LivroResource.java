package com.marco.bookstore.resources;
...
import com.marco.bookstore.dtos.LivroDTO;
import com.marco.bookstore.service.LivroService;
...
public class LivroResource {
	...
	@GetMapping(value = "/{id}")
	public ResponseEntity<Livro> findBiId(@PathVariable Integer id){
